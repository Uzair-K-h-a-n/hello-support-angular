...
@Component({
  selector: 'app-affordable-medicare-plans-public',
  templateUrl: './affordable-medicare-plans-public.component.html',
  styleUrls: ['./affordable-medicare-plans-public.component.scss']
})
export class AffordableMedicarePlansPublicComponent implements OnInit {
  ...
  addData() {
    ...
    this.loader=true;
    this.productService.addAffordableMedicarePublic(this.affordableMedicareForm.value).subscribe(
      (res) => {
