...
@Component({
  selector: 'debt-settlementsolution',
  templateUrl: './debt-settlementsolution.component.html',
  styleUrls: ['./debt-settlementsolution.component.scss']
})
export class DebtSettlementSolutionComponent implements OnInit {
  ...
  addData() {
    ...
    this.loader=true;
    this.productService.addDebtSettlementSolution(this. debtSettlementSolutionForm.value).subscribe(
      (res) => {
