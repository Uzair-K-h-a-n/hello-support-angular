...
@Component({
  selector: 'medicare-cms',
  templateUrl: './medicare-cms.component.html',
  styleUrls: ['./medicare-cms.component.scss']
})
export class MedicareCmsComponent implements OnInit {
  ...
  addData() {
    ...
    this.loader = true;
    this.productService.addMedicareCms(this.medicareCmsForm.value).subscribe(
      (res) => {
